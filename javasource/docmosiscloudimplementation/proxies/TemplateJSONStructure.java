...
public class TemplateJSONStructure
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "DocmosisCloudImplementation.TemplateJSONStructure"));
	}
	...
	protected TemplateJSONStructure(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject templateJSONStructureMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("DocmosisCloudImplementation.TemplateJSONStructure", templateJSONStructureMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a DocmosisCloudImplementation.TemplateJSONStructure");
	...
	{
		return "DocmosisCloudImplementation.TemplateJSONStructure";
	}

...
public class RenderDevMode
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "DocmosisCloudImplementation.RenderDevMode"));
	}
	...
	protected RenderDevMode(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject renderDevModeMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("DocmosisCloudImplementation.RenderDevMode", renderDevModeMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a DocmosisCloudImplementation.RenderDevMode");
	...
	{
		return "DocmosisCloudImplementation.RenderDevMode";
	}
